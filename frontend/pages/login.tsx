...
export default function LoginPage() {
  ...
  return (
    <>
      <Head>
        <title>로그인 - Motion Sound</title>
        <meta name="description" content="Motion Sound에 로그인하세요" />
      </Head>
      <Header />
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M12 3C6.48 3 2 6.48 2 11c0 2.84 1.89 5.35 4.7 6.71L6 21l3.29-1.29C9.65 20.11 10.8 20.5 12 20.5c5.52 0 10-3.48 10-8S17.52 3 12 3z" fill="#000000"/>
              </svg>
              Kakao로 로그인
            </button>
